...
export const ForgotPasswordSuccess = ({ email, onResendEmail, isResending }: ForgotPasswordSuccessProps) => {
    return (
                ...
                <div className="bg-base-200 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="text-sm text-base-content/70">
                            <p className="font-medium mb-1">No olvides revisar tu carpeta de spam</p>
